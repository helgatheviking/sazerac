			...
			if ( function_exists( 'get_the_archive_title' ) ) :
				...
				*/
						...
						elseif ( is_author() ) :
                            ...
                            */
							the_post();
							printf( __( 'Author: %s', 'sazerac' ), '<span class="vcard">' . get_the_author() . '</span>' );
						...
						elseif ( is_day() ) :
							printf( __( 'Day: %s', 'sazerac' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'sazerac' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'sazerac' ) ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'sazerac' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'sazerac' ) ) . '</span>' );
